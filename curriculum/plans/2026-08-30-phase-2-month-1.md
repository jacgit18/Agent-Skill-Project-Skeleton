...
## Months 6-9 (parallel): Project 3 — AI Investment Advisor
**Standalone project**, sequenced beside the dashboard polish. Reuses the same stack and
every pattern learned in the dashboard arc (chat, structured output, tool-calling, RAG), but
points them at a real portfolio: an AI advisor that runs the `.claude/skills/Finance/`
decision gates against actual holdings. The dashboard stays a skills-practice sandbox; this
is the "real utility" portfolio piece. Full plan:
[`../journals/project-3-plan.md`](../journals/project-3-plan.md).
