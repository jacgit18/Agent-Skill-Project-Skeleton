...
#todo/BAU/dev 
- [ ] weather your doing TDD or just doing testing watch out when creating util functions in testing code you experience unexpected behavior which can alter test results. 
