...
1. **[[Service discovery]]**: Service meshes help microservices discover and locate other services within the system. This allows services to dynamically locate and communicate with each other without hardcoding network addresses. If you only this functionality you can use technologies like [[Architecture/02. Backing Service Options/Library/03.Backend/Eureka Service]].  
