...
dg-publish: false
---
![[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/_Infographic/BucketSort.gif]]
...
If we were to employ a comparison-based sorting algorithm, such as Merge Sort, Heap Sort, or Quick Sort, we'd be bound by the lower limit of [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Algorithms/Big O#^64043d| Ω]](n log n), which means they can't perform better than n log n in terms of time complexity.
