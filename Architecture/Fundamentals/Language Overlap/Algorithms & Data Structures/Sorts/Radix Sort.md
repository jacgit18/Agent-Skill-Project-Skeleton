...
Non-comparative sorting algorithms like [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Sorts/Counting Sort]] and radix sort are primarily suitable for fixed-length integers, and they can outperform the typical` O(n log n)` time complexity of comparison-based sorts.  Radix sort has `best/average/worst ` runtime of  **[[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Algorithms/Big O#^64043d| Ω(nk)]]**,  **[[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Algorithms/Big O#^68b727| Θ(nk)]]** **[[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Algorithms/Big O#^93b0ef| O(nk)]]**, and space complexity of `O(n+k)`.  Additionally, you may encounter another non comparative sorting method called [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Sorts/Bucket Sort]]. 
