...
dg-publish:
---
![[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/_Gif/Regimen.gif]]
## Prep  
...
1. **Focus on One Problem**: 
	...
	- Keep in mind when to change [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Algorithms/Approach Pivot|Approach]]
...
2. [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/AlgoFlow#**Brute Force Algorithm**|Bruteforce]] **Solution**:  
	- Come up with a Bruteforce solution to gain insight into the problem's dynamics.  
	- Break the problem down until you understand it think about the [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Algo pathway|Attributes of Data]] being passed.  
  
3. [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/AlgoFlow#**Naïve Algorithm**|Naive]] **Solution**:  
	- Develop a naive solution, distinct from the Bruteforce approach.  
	- Space out attempts, allowing time for fresh perspectives.
	- The Naive solution can be done [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Common Imperative Algorithms|Imperatively]] or [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Common Declarative Algorithms|Declarative]] consider doing both ways to see if you can do it.
	- Also think about [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/All Sorts of Sorts|Sorting]] algorithms in terms what can be applied, you don't necessarily need write one but you can use a pre-made sorting algorithm.
	- Lastly consider runtime complexity and data structures brainstorming thinking about their application in terms of access, searching, insertion, and deletion both [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Linear  Data Structures/Linear Data Structure Runtime Comparison|Linear]] and [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Non-Linear Data Structures/Non-Linear Data Structure Runtime Comparison|Non-Linear]]

  
4. [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/AlgoFlow#**Optimal Algorithm**|Optimal]] **Solution & [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Patterns/Key Base Attributes of  Grokking Algorithm patterns|Grokking Algorithm]] Patterns**:
	- Develop a Optimal approach
	- Consider experiment with looping [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Algorithms/Iteration vs Recursion|iteratively]] and [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Recursion/Recursion & Recursion Runtime|recursively]].  
...
- [ ] [[Architecture/Fundamentals/Language Overlap/Algorithms & Data Structures/Algorithms/Dijkstra + Bellman-Ford shortest path]]
