...
Started:
EditDate: 2024-03-04
Relates: "[[Architecture/Fundamentals/Language Overlap/Callback]]"
Peer Reviewed: 0
dg-publish: false
---
...
In this example, `curry(func)` returns a wrapper function, enabling both normal and partial function calls. [[Architecture/Fundamentals/Language Overlap/Use of closure & composition|Closure]] is being used to pass the function `sum` to `curry` as a callback. 
