...
- When a method is declared as [[Architecture/Fundamentals/Language Overlap/static Keyword|static]], it can be called on the class itself rather than on an instance of the class. This is why you can call `doWork(acct)` even though `acct` is an instance variable.
