...
![[Architecture/Fundamentals/Language Overlap/_Infographic/Class Diagram.png]]
### ChatGpt Prompt
#todo/prompts
...
What UML sign is for access [[Architecture/Fundamentals/Language Overlap/Protected in Depth]] modifier;; hashtag
...
- [[Architecture/Fundamentals/Language Overlap/Protected in Depth|Protected]] - member can only be accessed within its package and by a subclass of its class in another package used a lot with `UUID`.
```java
# protected
```
...
- [[Architecture/Fundamentals/Language/Java/Static methods|Static]]- both belong to the class and not the object. also in uml is represented by being underlined and a little bold. static members are used so, there will be one and only one copy of the member.
