...
The `@Retention(RetentionPolicy.RUNTIME)` annotation indicates that the `ProcessedBy` annotation information should be retained at runtime, allowing [[Architecture/Fundamentals/Language Overlap/Introspection vs Reflection|reflection]] to access it.
