...
On the other hand, the [[Architecture/02. Backing Service Options/Library/02.Frontend/Redux/Base/Connect is a higher order component|connect]] function, being a higher-order function, empowers a component to be "smart" or "connected" to the Redux state store. This means the component gains awareness of the state managed by Redux.
