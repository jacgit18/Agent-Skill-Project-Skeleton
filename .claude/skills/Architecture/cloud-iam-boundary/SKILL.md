...
Follow-ups:          <execution model this role attaches to → serverless-execution-model; edge/DDoS protection if internet-facing → resilience-strategy; encryption/secrets → name and defer; audit alerting → observability-strategy>
```
