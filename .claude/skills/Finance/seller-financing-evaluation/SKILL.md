...
description: |-
  A seller-financed (owner-financed) business purchase — seller acts as lender, not a bank — and the question is the terms' fairness, take-it-or-not, or negotiation. Triggers: "is this seller financing deal fair", "should I do owner financing on this business", a stated set of terms (down payment, rate, term, price). Forces the monthly payment computed via amortization, benchmarked against market ranges (10-50% down, 5-10% interest, 3-7yr term); and a named seller-motivation diagnostic (the "7 Ds": Death, Disease, Dullness, Departure, Disagreement, Distress, Divorce) changing negotiating leverage by why the seller is actually selling. Not vendor/product financing for equipment or software — `technical-cost-decision` (no seller-as-lender, no business changing hands). Not whether to buy the business at all — sourcing, due diligence, valuation aren't covered. Not a substitute for an attorney, accountant, or appraiser — names them, never drafts the note or purchase agreement.
---
