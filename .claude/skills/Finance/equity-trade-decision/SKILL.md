...
1. **Fundamentals.** Actually reviewed the latest annual report / 10-K, not assumed sound.
   ...
   this catalog. If the name arrived by narrative (a video, a tip, "I use the product") and
   never cleared a numeric screen, run `watchlist-screener-criteria` before this checklist —
   it's the gate before this gate.
